...
const Why = () => {
  ...
  <div className="container">
    <div className="section-head center reveal">
      <div className="eyebrow" style={{ color: '#FF9933', fontWeight: 900, fontSize: '2rem', textTransform: 'uppercase', letterSpacing: '2px', textShadow: '0 0 10px rgba(255, 153, 51, 0.6)' }}>Why JC TECH?</div>
