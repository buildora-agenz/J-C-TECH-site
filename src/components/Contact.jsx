    ...
    <div className="contact-wrap">
      ...
      <div className="reveal">
        <div className="contact-info">
          <div className="info-row"><div className="info-ic"><svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4h16v16H4z" opacity="0"/><path d="M22 6l-10 7L2 6"/><rect x="2" y="4" width="20" height="16" rx="2"/></svg></div><div><b>Email</b><a href="mailto:gopiinath.c@gmail.com">gopiinath.c@gmail.com</a></div></div>
          <div className="info-row"><div className="info-ic"><svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M3 5a2 2 0 012-2h3l2 5-2.5 1.5a11 11 0 005 5L14 12l5 2v3a2 2 0 01-2 2A16 16 0 013 5z"/></svg></div><div><b>WhatsApp</b><a href="https://wa.me/919940226776?text=Hi%20JC%20Tech%2C%20I%27d%20like%20to%20know%20more%20about%20your%20courses." target="_blank" rel="noopener">+91 99402 26776</a></div></div>
          <div className="info-row"><div className="info-ic"><svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><path d="M16 8a6 6 0 016 6v7h-4v-7a2 2 0 00-4 0v7h-4v-7a6 6 0 016-6z"/><rect x="2" y="9" width="4" height="12"/><circle cx="4" cy="4" r="2"/></svg></div><div><b>Phone</b><a href="tel:+919940226776">+91 99402 26776</a></div></div>
          <div className="info-row"><div className="info-ic"><svg viewBox="0 0 24 24" fill="none" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="3"/><path d="M10 9l5 3-5 3z"/></svg></div><div><b>Website</b><a href="https://jctechindia.com">jctechindia.com</a></div></div>
        </div>
