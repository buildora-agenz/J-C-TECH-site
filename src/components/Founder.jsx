  ...
  <div className="container">
    <div className="founder-wrap">
      ...
      <div className="reveal">
        ...
        <h2 style={{ color: 'var(--white)', marginBottom: '0.5rem', fontSize: '2.5rem' }}>Gopinath Chidambaram</h2>
        ...
        <p className="founder-quote" style={{ fontStyle: 'normal', color: 'var(--grey-400)', fontSize: '1.1rem', marginBottom: '1rem', lineHeight: '1.7' }}>
        ...
        <p className="founder-quote" style={{ fontStyle: 'normal', color: 'var(--grey-400)', fontSize: '1.1rem', marginBottom: '2rem', lineHeight: '1.7' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', background: 'rgba(255,255,255,0.03)', padding: '2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
          <div>
            <h4 style={{ color: 'var(--white)', marginBottom: '0.5rem' }}>My Mission</h4>
            <p style={{ color: '#93A2C4', lineHeight: '1.6', margin: 0 }}>To empower engineers with practical knowledge, modern engineering technologies and real industrial experience, enabling them to solve complex engineering problems with confidence and innovation.</p>
          </div>
          <div>
            <h4 style={{ color: 'var(--white)', marginBottom: '0.5rem' }}>Vision</h4>
            <p style={{ color: '#93A2C4', lineHeight: '1.6', margin: 0 }}>To build India's most trusted Engineering Intelligence Company by integrating CAD, Artificial Intelligence, Electric Vehicles and Engineering Consulting into one unified platform for learning, innovation and industrial transformation.</p>
          </div>
        </div>
      </div>
    </div>
